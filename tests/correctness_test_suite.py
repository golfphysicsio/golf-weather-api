...
PROFESSIONAL_SCENARIOS = [
    # Category 1: Driver Shots (1-10)
    {
        ...
        "expected_min": 275, "expected_max": 285, "category": "Driver", "validation": "Baseline"
    },
    {
        ...
        "expected_min": 280, "expected_max": 290, "category": "Driver", "validation": "Heat bonus"
    },
    {
        ...
        "expected_min": 260, "expected_max": 270, "category": "Driver", "validation": "Cold penalty"
    },
    {
        ...
        "expected_min": 290, "expected_max": 305, "category": "Driver", "validation": "Altitude bonus"
    },
    {
        ...
        "expected_min": 245, "expected_max": 260, "category": "Driver", "validation": "Wind penalty"
    },
    {
        ...
        "expected_min": 295, "expected_max": 310, "category": "Driver", "validation": "Wind bonus"
    },
    {
        ...
        "expected_min": 270, "expected_max": 285, "category": "Driver", "validation": "Minimal carry impact"
    },
    {
        "id": 8, "name": "Driver - Lower ball speed",
        "input": {"ball_speed": 145, "launch_angle": 13.0, "spin_rate": 3200,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 225, "expected_max": 235, "category": "Driver", "validation": "Lower speed"
    },
    {
        "id": 9, "name": "Driver - Tour pro speed",
        "input": {"ball_speed": 180, "launch_angle": 10.0, "spin_rate": 2400,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 300, "expected_max": 315, "category": "Driver", "validation": "Higher speed"
    },
    {
        "id": 10, "name": "Driver - Extreme altitude",
        "input": {"ball_speed": 167, "launch_angle": 11.2, "spin_rate": 2600,
                  "conditions_override": {"wind_speed": 5, "wind_direction": 90, "temperature": 72, "humidity": 30, "altitude": 10000, "air_pressure": 20.0}},
        "expected_min": 310, "expected_max": 330, "category": "Driver", "validation": "Extreme altitude"
    },
    ...
    # Category 2: Iron Shots (11-25)
    {
        ...
        "input": {"ball_speed": 125, "launch_angle": 16.0, "spin_rate": 5500,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 175, "expected_max": 185, "category": "Iron", "validation": "Mid iron baseline"
    },
    {
        ...
        "expected_min": 180, "expected_max": 190, "category": "Iron", "validation": "Heat effect"
    },
    {
        ...
        "expected_min": 165, "expected_max": 175, "category": "Iron", "validation": "Cold effect"
    },
    {
        ...
        "expected_min": 155, "expected_max": 170, "category": "Iron", "validation": "Wind penalty"
    },
    {
        ...
        "expected_min": 185, "expected_max": 200, "category": "Iron", "validation": "Wind bonus"
    },
    {
        "id": 16, "name": "5-iron - Calm",
        "input": {"ball_speed": 135, "launch_angle": 14.0, "spin_rate": 4500,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 195, "expected_max": 205, "category": "Iron", "validation": "Long iron"
    },
    {
        ...
        "expected_min": 205, "expected_max": 220, "category": "Iron", "validation": "Altitude"
    },
    {
        "id": 18, "name": "9-iron - Calm",
        "input": {"ball_speed": 115, "launch_angle": 19.0, "spin_rate": 6500,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 155, "expected_max": 165, "category": "Iron", "validation": "Short iron"
    },
    {
        ...
        "expected_min": 140, "expected_max": 155, "category": "Iron", "validation": "Wind on short iron"
    },
    {
        "id": 20, "name": "4-iron - Calm",
        "input": {"ball_speed": 140, "launch_angle": 13.0, "spin_rate": 4200,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 205, "expected_max": 215, "category": "Iron", "validation": "Strong long iron"
    },
    {
        "id": 21, "name": "6-iron - Calm",
        "input": {"ball_speed": 130, "launch_angle": 15.0, "spin_rate": 5000,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 185, "expected_max": 195, "category": "Iron", "validation": "Mid-distance iron"
    },
    {
        "id": 22, "name": "8-iron - Calm",
        "input": {"ball_speed": 120, "launch_angle": 17.5, "spin_rate": 6000,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 165, "expected_max": 175, "category": "Iron", "validation": "Control iron"
    },
    {
        "id": 23, "name": "7-iron - Slower swing",
        "input": {"ball_speed": 102, "launch_angle": 19.0, "spin_rate": 6300,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 130, "expected_max": 140, "category": "Iron", "validation": "Slower swing"
    },
    {
        ...
        "expected_min": 110, "expected_max": 130, "category": "Iron", "validation": "Extreme wind"
    },
    {
        ...
        "expected_min": 210, "expected_max": 225, "category": "Iron", "validation": "Hot + altitude"
    },
    ...
    # Category 3: Wedge Shots (26-35)
    {
        ...
        "input": {"ball_speed": 110, "launch_angle": 21.0, "spin_rate": 7000,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 145, "expected_max": 155, "category": "Wedge", "validation": "Pitching wedge"
    },
    {
        "id": 27, "name": "PW - Headwind",
        "input": {"ball_speed": 110, "launch_angle": 21.0, "spin_rate": 7000,
                  "conditions_override": {"wind_speed": 15, "wind_direction": 0, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 130, "expected_max": 145, "category": "Wedge", "validation": "Wind effect"
    },
    {
        ...
        "expected_min": 155, "expected_max": 170, "category": "Wedge", "validation": "Wind boost"
    },
    {
        "id": 29, "name": "GW - Calm",
        "input": {"ball_speed": 100, "launch_angle": 24.0, "spin_rate": 8000,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 125, "expected_max": 135, "category": "Wedge", "validation": "Gap wedge"
    },
    {
        "id": 30, "name": "SW - Calm",
        "input": {"ball_speed": 90, "launch_angle": 27.0, "spin_rate": 9000,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 105, "expected_max": 115, "category": "Wedge", "validation": "Sand wedge"
    },
    {
        "id": 31, "name": "LW - Calm",
        "input": {"ball_speed": 80, "launch_angle": 30.0, "spin_rate": 9500,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 85, "expected_max": 95, "category": "Wedge", "validation": "Lob wedge"
    },
    {
        "id": 32, "name": "PW - Mid-handicap",
        "input": {"ball_speed": 87, "launch_angle": 25.0, "spin_rate": 8000,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 100, "expected_max": 110, "category": "Wedge", "validation": "Mid-handicap PW"
    },
    {
        "id": 33, "name": "SW - High altitude",
        "input": {"ball_speed": 90, "launch_angle": 27.0, "spin_rate": 9000,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 30, "altitude": 8500, "air_pressure": 22.0}},
        "expected_min": 115, "expected_max": 125, "category": "Wedge", "validation": "High altitude wedge"
    },
    {
        "id": 34, "name": "GW - Cold",
        "input": {"ball_speed": 100, "launch_angle": 24.0, "spin_rate": 8000,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 28, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 115, "expected_max": 125, "category": "Wedge", "validation": "Cold wedge"
    },
    {
        "id": 35, "name": "LW - Headwind",
        "input": {"ball_speed": 80, "launch_angle": 30.0, "spin_rate": 9500,
                  "conditions_override": {"wind_speed": 20, "wind_direction": 0, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 70, "expected_max": 85, "category": "Wedge", "validation": "Wind on lob"
    },
    ...
    # Category 4: Woods (36-45)
    {
        ...
        "input": {"ball_speed": 158, "launch_angle": 10.5, "spin_rate": 3200,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 250, "expected_max": 260, "category": "Wood", "validation": "3-wood baseline"
    },
    {
        "id": 37, "name": "3-wood - Tailwind",
        "input": {"ball_speed": 158, "launch_angle": 10.5, "spin_rate": 3200,
                  "conditions_override": {"wind_speed": 20, "wind_direction": 180, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 270, "expected_max": 285, "category": "Wood", "validation": "Wind assist"
    },
    {
        "id": 38, "name": "3-wood - Headwind",
        "input": {"ball_speed": 158, "launch_angle": 10.5, "spin_rate": 3200,
                  "conditions_override": {"wind_speed": 20, "wind_direction": 0, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 230, "expected_max": 245, "category": "Wood", "validation": "Into wind"
    },
    {
        "id": 39, "name": "5-wood - Calm",
        "input": {"ball_speed": 150, "launch_angle": 11.0, "spin_rate": 3800,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 230, "expected_max": 240, "category": "Wood", "validation": "5-wood"
    },
    {
        "id": 40, "name": "5-wood - Denver altitude",
        "input": {"ball_speed": 150, "launch_angle": 11.0, "spin_rate": 3800,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 40, "altitude": 5280, "air_pressure": 25.0}},
        "expected_min": 245, "expected_max": 260, "category": "Wood", "validation": "Denver 5-wood"
    },
    {
        "id": 41, "name": "3-wood - Slower speed",
        "input": {"ball_speed": 148, "launch_angle": 11.0, "spin_rate": 3400,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 230, "expected_max": 240, "category": "Wood", "validation": "Slower 3-wood"
    },
    {
        "id": 42, "name": "5-wood - Mid speed",
        "input": {"ball_speed": 140, "launch_angle": 11.5, "spin_rate": 4000,
                  "conditions_override": {"wind_speed": 3, "wind_direction": 90, "temperature": 72, "humidity": 50, "altitude": 0, "air_pressure": 29.92}},
        "expected_min": 210, "expected_max": 220, "category": "Wood", "validation": "Mid-speed 5-wood"
    },
    {
        ...
        "expected_min": 255, "expected_max": 265, "category": "Wood", "validation": "Heat on wood"
    },
    {
        ...
        "expected_min": 215, "expected_max": 225, "category": "Wood", "validation": "Cold fairway wood"
    },
    {
        ...
        "expected_min": 245, "expected_max": 260, "category": "Wood", "validation": "Side wind wood"
    },
    ...
    # Category 5: Edge Cases (46-50)
    {
        ...
        "expected_min": 100, "expected_max": 150, "category": "Edge", "validation": "Extreme penalty"
    },
    {
        ...
        "expected_min": 275, "expected_max": 285, "category": "Edge", "validation": "No wind effect"
    },
    {
        ...
        "expected_min": 240, "expected_max": 260, "category": "Edge", "validation": "Cold limit"
    },
    {
        ...
        "expected_min": 285, "expected_max": 300, "category": "Edge", "validation": "Heat limit"
    },
    {
        "id": 50, "name": "Maximum altitude",
        "input": {"ball_speed": 167, "launch_angle": 11.2, "spin_rate": 2600,
                  "conditions_override": {"wind_speed": 5, "wind_direction": 90, "temperature": 72, "humidity": 30, "altitude": 15000, "air_pressure": 18.0}},
        "expected_min": 330, "expected_max": 360, "category": "Edge", "validation": "Extreme thin air"
    },
]
...
GAMING_SCENARIOS = [
    ...
    {"id": 51, "name": "Scratch - calm_day", "handicap": 0, "club": "driver", "preset": "calm_day", "expected_min": 275, "expected_max": 285, "category": "Presets", "validation": "Baseline"},
    {"id": 52, "name": "Scratch - hurricane_hero", "handicap": 0, "club": "driver", "preset": "hurricane_hero", "expected_min": 310, "expected_max": 370, "category": "Presets", "validation": "Tailwind boost"},
    {"id": 53, "name": "Scratch - arctic_assault", "handicap": 0, "club": "driver", "preset": "arctic_assault", "expected_min": 150, "expected_max": 180, "category": "Presets", "validation": "Cold + headwind"},
    {"id": 54, "name": "Scratch - desert_inferno", "handicap": 0, "club": "driver", "preset": "desert_inferno", "expected_min": 280, "expected_max": 305, "category": "Presets", "validation": "Heat + altitude"},
    {"id": 55, "name": "Scratch - tornado_alley", "handicap": 0, "club": "driver", "preset": "tornado_alley", "expected_min": 260, "expected_max": 290, "category": "Presets", "validation": "Crosswind"},
    {"id": 56, "name": "Scratch - monsoon_madness", "handicap": 0, "club": "driver", "preset": "monsoon_madness", "expected_min": 300, "expected_max": 340, "category": "Presets", "validation": "Tailwind tropical"},
    {"id": 57, "name": "Scratch - mountain_challenge", "handicap": 0, "club": "driver", "preset": "mountain_challenge", "expected_min": 300, "expected_max": 340, "category": "Presets", "validation": "High altitude"},
    {"id": 58, "name": "Scratch - polar_vortex", "handicap": 0, "club": "driver", "preset": "polar_vortex", "expected_min": 115, "expected_max": 150, "category": "Presets", "validation": "Extreme cold + headwind"},
    {"id": 59, "name": "Scratch - dust_bowl", "handicap": 0, "club": "driver", "preset": "dust_bowl", "expected_min": 295, "expected_max": 330, "category": "Presets", "validation": "Dry heat + tailwind"},
    {"id": 60, "name": "Scratch - typhoon_terror", "handicap": 0, "club": "driver", "preset": "typhoon_terror", "expected_min": 50, "expected_max": 90, "category": "Presets", "validation": "Devastating headwind"},

    # Category 2: All Handicap Tiers x 7-Iron x Calm (61-64)
    {"id": 61, "name": "Scratch 7-iron calm", "handicap": 2, "club": "7_iron", "preset": "calm_day", "expected_min": 180, "expected_max": 210, "category": "Tiers", "validation": "Longest"},
    {"id": 62, "name": "Low 7-iron calm", "handicap": 10, "club": "7_iron", "preset": "calm_day", "expected_min": 155, "expected_max": 180, "category": "Tiers", "validation": "2nd"},
    {"id": 63, "name": "Mid 7-iron calm", "handicap": 15, "club": "7_iron", "preset": "calm_day", "expected_min": 130, "expected_max": 160, "category": "Tiers", "validation": "3rd"},
    {"id": 64, "name": "High 7-iron calm", "handicap": 25, "club": "7_iron", "preset": "calm_day", "expected_min": 105, "expected_max": 135, "category": "Tiers", "validation": "Shortest"},

    # Category 3: All Tiers x Driver x Hurricane Hero (65-68)
    {"id": 65, "name": "Scratch driver hurricane", "handicap": 2, "club": "driver", "preset": "hurricane_hero", "expected_min": 310, "expected_max": 380, "category": "Hurricane", "validation": "Longest"},
    {"id": 66, "name": "Low driver hurricane", "handicap": 10, "club": "driver", "preset": "hurricane_hero", "expected_min": 290, "expected_max": 360, "category": "Hurricane", "validation": "2nd"},
    {"id": 67, "name": "Mid driver hurricane", "handicap": 15, "club": "driver", "preset": "hurricane_hero", "expected_min": 260, "expected_max": 330, "category": "Hurricane", "validation": "3rd"},
    {"id": 68, "name": "High driver hurricane", "handicap": 25, "club": "driver", "preset": "hurricane_hero", "expected_min": 230, "expected_max": 300, "category": "Hurricane", "validation": "Shortest"},

    # Category 4: Club Progression x Mid Handicapper x Calm (69-78)
    {"id": 69, "name": "Mid driver calm", "handicap": 15, "club": "driver", "preset": "calm_day", "expected_min": 220, "expected_max": 250, "category": "Clubs", "validation": "Longest"},
    {"id": 70, "name": "Mid 3-wood calm", "handicap": 15, "club": "3_wood", "preset": "calm_day", "expected_min": 195, "expected_max": 225, "category": "Clubs", "validation": "2nd"},
    {"id": 71, "name": "Mid 5-iron calm", "handicap": 15, "club": "5_iron", "preset": "calm_day", "expected_min": 145, "expected_max": 175, "category": "Clubs", "validation": "Mid"},
    {"id": 72, "name": "Mid 7-iron calm", "handicap": 15, "club": "7_iron", "preset": "calm_day", "expected_min": 125, "expected_max": 155, "category": "Clubs", "validation": "Short-mid"},
    {"id": 73, "name": "Mid 9-iron calm", "handicap": 15, "club": "9_iron", "preset": "calm_day", "expected_min": 105, "expected_max": 135, "category": "Clubs", "validation": "Short"},
    {"id": 74, "name": "Mid PW calm", "handicap": 15, "club": "pw", "preset": "calm_day", "expected_min": 95, "expected_max": 125, "category": "Clubs", "validation": "Very short"},
    {"id": 75, "name": "Mid GW calm", "handicap": 15, "club": "gw", "preset": "calm_day", "expected_min": 80, "expected_max": 110, "category": "Clubs", "validation": "Wedge"},
    {"id": 76, "name": "Mid SW calm", "handicap": 15, "club": "sw", "preset": "calm_day", "expected_min": 65, "expected_max": 95, "category": "Clubs", "validation": "Sand"},
    {"id": 77, "name": "Mid LW calm", "handicap": 15, "club": "lw", "preset": "calm_day", "expected_min": 50, "expected_max": 80, "category": "Clubs", "validation": "Shortest"},
    {"id": 78, "name": "Mid 3-iron calm", "handicap": 15, "club": "3_iron", "preset": "calm_day", "expected_min": 160, "expected_max": 195, "category": "Clubs", "validation": "Long iron"},

    # Category 5: Desert Inferno x All Tiers (79-82)
    {"id": 79, "name": "Scratch driver desert", "handicap": 2, "club": "driver", "preset": "desert_inferno", "expected_min": 290, "expected_max": 320, "category": "Desert", "validation": "Altitude bonus"},
    {"id": 80, "name": "Low driver desert", "handicap": 10, "club": "driver", "preset": "desert_inferno", "expected_min": 270, "expected_max": 300, "category": "Desert", "validation": "Altitude bonus"},
    {"id": 81, "name": "Mid driver desert", "handicap": 15, "club": "driver", "preset": "desert_inferno", "expected_min": 245, "expected_max": 275, "category": "Desert", "validation": "Altitude bonus"},
    {"id": 82, "name": "High driver desert", "handicap": 25, "club": "driver", "preset": "desert_inferno", "expected_min": 215, "expected_max": 250, "category": "Desert", "validation": "Altitude bonus"},

    # Category 6: Mountain Challenge x Various Clubs x Low Handicapper (83-87)
    {"id": 83, "name": "Low driver mountain", "handicap": 10, "club": "driver", "preset": "mountain_challenge", "expected_min": 285, "expected_max": 340, "category": "Mountain", "validation": "Large bonus"},
    {"id": 84, "name": "Low 7-iron mountain", "handicap": 10, "club": "7_iron", "preset": "mountain_challenge", "expected_min": 170, "expected_max": 210, "category": "Mountain", "validation": "Medium bonus"},
    {"id": 85, "name": "Low PW mountain", "handicap": 10, "club": "pw", "preset": "mountain_challenge", "expected_min": 130, "expected_max": 165, "category": "Mountain", "validation": "Small bonus"},
    {"id": 86, "name": "Low 3-wood mountain", "handicap": 10, "club": "3_wood", "preset": "mountain_challenge", "expected_min": 255, "expected_max": 310, "category": "Mountain", "validation": "Large bonus"},
    {"id": 87, "name": "Low SW mountain", "handicap": 10, "club": "sw", "preset": "mountain_challenge", "expected_min": 90, "expected_max": 120, "category": "Mountain", "validation": "Minimal bonus"},

    # Category 7: Polar Vortex x Various Clubs (88-91)
    {"id": 88, "name": "Scratch driver polar", "handicap": 2, "club": "driver", "preset": "polar_vortex", "expected_min": 115, "expected_max": 155, "category": "Polar", "validation": "Cold penalty"},
    {"id": 89, "name": "Mid driver polar", "handicap": 15, "club": "driver", "preset": "polar_vortex", "expected_min": 100, "expected_max": 145, "category": "Polar", "validation": "Cold penalty"},
    {"id": 90, "name": "Low 7-iron polar", "handicap": 10, "club": "7_iron", "preset": "polar_vortex", "expected_min": 85, "expected_max": 130, "category": "Polar", "validation": "Cold penalty"},
    {"id": 91, "name": "Mid PW polar", "handicap": 15, "club": "pw", "preset": "polar_vortex", "expected_min": 50, "expected_max": 90, "category": "Polar", "validation": "Cold penalty"},
    ...
    {"id": 92, "name": "Custom strong headwind", "handicap": 15, "club": "driver",
     ...
     "expected_min": 170, "expected_max": 220, "category": "Custom", "validation": "Strong wind penalty"},
    {"id": 93, "name": "Custom slight tailwind", "handicap": 2, "club": "7_iron",
     ...
     "expected_min": 185, "expected_max": 210, "category": "Custom", "validation": "Slight boost"},
    {"id": 94, "name": "Custom crosswind", "handicap": 25, "club": "pw",
     ...
     "expected_min": 75, "expected_max": 105, "category": "Custom", "validation": "Crosswind + altitude"},
    {"id": 95, "name": "Custom heat + altitude", "handicap": 10, "club": "3_wood",
     ...
     "expected_min": 250, "expected_max": 290, "category": "Custom", "validation": "Heat + altitude"},
    {"id": 96, "name": "Custom cold + headwind", "handicap": 15, "club": "sw",
     ...
     "expected_min": 50, "expected_max": 80, "category": "Custom", "validation": "Cold + wind"},

    # Category 9: Edge Cases Gaming (97-100)
    {"id": 97, "name": "Min handicap (0)", "handicap": 0, "club": "driver", "preset": "calm_day", "expected_min": 270, "expected_max": 295, "category": "Edge", "validation": "Best player"},
    {"id": 98, "name": "Max handicap (36)", "handicap": 36, "club": "driver", "preset": "calm_day", "expected_min": 180, "expected_max": 220, "category": "Edge", "validation": "Worst player"},
...
async def run_all_tests():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        for scenario in PROFESSIONAL_SCENARIOS:
            ...
            print(f"  {status_icon} #{result['id']:3d} {result['name'][:40]:40s} | {carry_str:10s} | {result['expected_range']:15s} | {result['response_time_ms']:.0f}ms")
...
def generate_report():
    ...
    # Check ordering (better players hit farther)
    tier_results = [r for r in results["gaming"] if r["category"] == "Tiers" and r["status"] == "PASS"]
    tier_order_ok = True
    if len(tier_results) == 4:
        distances = [r.get("actual_carry", 0) for r in sorted(tier_results, key=lambda x: x["id"])]
        tier_order_ok = all(distances[i] > distances[i+1] for i in range(len(distances)-1))

    # Check club ordering
    club_results = [r for r in results["gaming"] if r["category"] == "Clubs" and r["status"] == "PASS"]
    ...
    for r in results["professional"]:
        if r["id"] == 5 and r["status"] == "PASS":  # Headwind
            baseline = next((x for x in results["professional"] if x["id"] == 1), None)
            if baseline and baseline["status"] == "PASS":
                headwind_ok = r["actual_carry"] < baseline["actual_carry"]
        if r["id"] == 6 and r["status"] == "PASS":  # Tailwind
            baseline = next((x for x in results["professional"] if x["id"] == 1), None)
            if baseline and baseline["status"] == "PASS":
                tailwind_ok = r["actual_carry"] > baseline["actual_carry"]
        if r["id"] == 4 and r["status"] == "PASS":  # Altitude
            baseline = next((x for x in results["professional"] if x["id"] == 1), None)
            if baseline and baseline["status"] == "PASS":
                altitude_ok = r["actual_carry"] > baseline["actual_carry"]

    report.append(f"- {'PASS' if tier_order_ok else 'FAIL'} Handicap tier ordering (better players > worse players)")
    report.append(f"- {'PASS' if len(club_results) >= 8 else 'FAIL'} Club distance ordering (driver > irons > wedges)")
    report.append(f"- {'PASS' if headwind_ok else 'FAIL'} Headwind reduces distance")
    report.append(f"- {'PASS' if tailwind_ok else 'FAIL'} Tailwind increases distance")
    report.append(f"- {'PASS' if altitude_ok else 'FAIL'} Altitude increases distance")
    report.append(f"- {'PASS' if results['summary']['failed'] == 0 else 'WARN'} No unrealistic distances")
    report.append("")
    ...
    if pass_rate >= 95 and results['performance']['p95_ms'] < 500:
        ...
        if pass_rate < 95:
            report.append(f"1. Pass rate ({pass_rate:.1f}%) is below 95% threshold")
